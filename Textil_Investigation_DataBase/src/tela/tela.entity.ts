...
export class TelaEntity {
  ...
  tipo_estructurales: TipoEstructuralEntity[];
    ...
    @ManyToMany(() => Cac_TecnicasEntity, (caracteristicaTecnica) => caracteristicaTecnica.telas)
    @JoinTable()
    ...
    @ManyToMany(() => EstructuraLigamentosEntity, (estructuraLigamento) => estructuraLigamento.telas)
    @JoinTable()
